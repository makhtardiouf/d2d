...
public:
   ...
   */
  virtual Ipv6InterfaceContainer AssignUeIpv6Address (NetDeviceContainer ueDevices) {return Ipv6InterfaceContainer();}
  ...
  virtual Ipv6Address GetUeDefaultGatewayAddress6 () {return Ipv6Address::GetAny();}
