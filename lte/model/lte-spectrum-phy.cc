    ...
    switch (m_state)
    {
        ...
        case IDLE:
        {
            ...
            txParams->cellId = m_cellId;
             ...
             if (m_inD2dMode)
            {                       
                NS_LOG_DEBUG ("Sending in D2D mode");
                Simulator::ScheduleWithContext (m_d2dPeer.nodeId, MilliSeconds (10.0), &LteSpectrumPhy::StartRxData, m_d2dPeer.spectrumPhy, txParams);
              //  return true;
            }
    ...
    switch (m_state)
    {
        ...
        case RX_UL_SRS:
            ...
            if (m_inD2dMode)
            {
                ...
                NS_LOG_LOGIC (this << "\n D2D: scheduling EndRx with delay "
                              << lteDlCtrlRxParams->duration << " cellId = " << cellId);
                ...
                return m_interferenceCtrl->StartRx (lteDlCtrlRxParams->psd);
            }
...
void
LteSpectrumPhy::SetLtePhyDiscoveryCallback (LtePhyDiscoveryCallback c)
{
    NS_LOG_FUNCTION (this);
    m_ltePhyDiscoveryCallback = c;
}

void
LteSpectrumPhy::SetLtePhyTxDiscoveryCallback (LtePhyTxDiscoveryCallback c)
{
    NS_LOG_FUNCTION (this);
    m_ltePhyTxDiscoveryCallback = c;
}

void
LteSpectrumPhy::SetLtePhyRxDiscoveryCallback (LtePhyRxDiscoveryCallback c)
{
    NS_LOG_FUNCTION (this);
    m_ltePhyRxDiscoveryCallback = c;
}

// D2D

DiscoveryMsgElement::DiscoveryMsgElement ()
{
    NS_LOG_FUNCTION (this);
