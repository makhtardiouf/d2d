...
public:
     ...
     * Note: It silently discards bogus packets.
     *
     ...
     * \param ueAddr6 the IPv6 address of the UE, defaults to 0
     */
    void SetUeAddress(uint64_t imsi, Ipv4Address ueAddr, Ipv6Address ueAddr6 = Ipv6Address::GetZero());
...
private:
    ...
    public:
        ...
        Ipv6Address GetEnbAddr6();

        /**
         * set the address of the eNB to which the UE is connected
         * along with the mapped IPv6
        ...
        /**
         * set the address of the UE, along with the mapped IPv6
         *
    ...
    {
        Ipv4Address enbAddr;
        Ipv6Address enbAddr6;

        Ipv4Address sgwAddr;
        Ipv6Address sgwAddr6;
    };
