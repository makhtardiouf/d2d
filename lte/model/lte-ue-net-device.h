...
#include "ns3/virtual-net-device.h" // D2D
...
public:
  ...
  // D2D
  void SetD2dMode(bool d2d, Ptr<VirtualNetDevice> n) {m_inD2dMode = d2d; m_d2dDev = n;}
  bool m_inD2dMode;
  Ptr<LteUeNetDevice> m_d2dPeerNetDev;
