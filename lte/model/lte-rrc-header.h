...
protected:
  ...
  // D2D SideLink
  Buffer::Iterator DeserializeSystemInformationBlockType18 (LteRrcSap::SystemInformationBlockType18 *systemInformationBlockType18, Buffer::Iterator bIterator);
  ///  Buffer::Iterator DeserializeSystemInformationBlockType19 (LteRrcSap::SystemInformationBlockType19 *systemInformationBlockType19, Buffer::Iterator bIterator);
