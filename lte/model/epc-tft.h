 ...
 * $Id: epc-tft.h, 2016-03-29 16:19 +0900 makhtar $
 */
...
public:
    ...
    private:
         ...
         * false otherwise.
         */
        bool MatchPortTos(uint16_t rp, uint16_t lp, uint8_t tos);
    ...
    public:
        ...
        Ipv6Prefix remoteMask6;
        Ipv6Prefix localMask6;
     ...
     *
     * \param direction
     * \param Ipv4/v6 remoteAddress
     * \param Ipv4/v6 localAddress
     * \param remotePort
     * \param localPort
     * \param typeOfService
     *
     ...
     */
    // Templating for Ipv4/v6 forces us to include the implementation in this header
    ...
    {
        std::clog << this << direction << remoteAddress << localAddress << std::dec
    ...
    /**
     * Return default TFT Id used for un-handled IPv6-related features
     */
    uint8_t GetDefaultTftId()
    {
