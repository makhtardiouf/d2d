...
void DoTransmitPdu(LteMacSapProvider::TransmitPduParameters params); // D2D public
private:
...
private:
    ...
    // makhtar D2D
    TracedCallback<Ptr<const Packet> > m_snifferRxTrace;
    bool m_inD2dMode;
    std::map <uint8_t, LcInfo>::const_iterator itD2d; 
};
