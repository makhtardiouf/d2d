...
public:
     ...
     * Ipv6 addresses are internally used if activated
    ...
    void SetIpv6(Ipv6Address localIp, Ipv6Address remoteIp)
    {
        m_localX2Address6 = localIp;
        m_remoteX2Address6 = remoteIp;
    }
...
private:
    ...
    Ipv6Address m_localX2Address6;
    // For X2IfaceInfo
    Ipv6Address m_remoteX2Address6;
