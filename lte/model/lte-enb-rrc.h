...
public:
   ...
   * \param transportLayerAddress  IPv4 Address of the SGW, see 36.423 9.2.1
   * \param transportLayerAddress6  IPv6 Address of the SGW
   */
  void SetupDataRadioBearer (EpsBearer bearer, uint8_t bearerId, uint32_t gtpTeid, Ipv4Address transportLayerAddress, Ipv6Address transportLayerAddress6 = Ipv6Address::GetZero() );
